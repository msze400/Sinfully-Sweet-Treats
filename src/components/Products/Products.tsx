...
const Products: FC<ProductsProps> = () => (
    <section className="text-gray-600 body-font">
        <div
            id="banner"
            tabIndex={-1}
            className="flex relative z-50 gap-8 justify-center text-center items-start py-3 px-4 w-full bg-gray-50 border border-b border-gray-200 sm:items-center dark:border-gray-700 lg:py-4 dark:bg-pink-400"
        >
