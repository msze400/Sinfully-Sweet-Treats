...
const HomePage: FC<HomePageProps> = () => {
    ...
    return (
        <>
            <NotificationBanner />
            <div
                className="grid grid-cols-10 bg-fixed bg-center bg-cover bg-no-repeat relative items-center  "
                style={{
            ...
            >
                <img
                    className="object-cover col-span-8 col-start-2 sm:col-start-3 md:col-start-7 h-1/2 sm:3/4 md:h-5/6 animate__animated animate__zoomIn"
                    src={logo}
                    alt="white-logo"
                ></img>
            </div>
